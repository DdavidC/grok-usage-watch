  ...
  if (displayDiv) {
    ...
    displayDiv.innerHTML = `
      ...
      <div style="margin-top: 8px;">
        ...
        <div style="font-size: 14px; color: #34495e; font-weight: bold; margin-top: 12px; margin-bottom: 4px;">Special Features</div>
        <div style="display: table; font-size: 16px; width: 100%;">
          <div style="display: table-row;">
      ...
      if (err.message === 'UNAUTHORIZED') {
        ...
        if (displayDiv) {
          displayDiv.innerHTML = `
            <strong style="color: #2c3e50; font-size: 16px; display: block; text-align: center;">Grok Query Balance</strong>
            <div style="margin-top: 8px;">
              <div style="color: #7f8c8d; text-align: center;">Loading...</div>
            </div>
          `;
        }
        return;
